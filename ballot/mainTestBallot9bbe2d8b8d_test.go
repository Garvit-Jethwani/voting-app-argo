...
var port = "8080" // TODO: Change this to your actual port
...
func httpClientRequest(method, url, path string, body io.Reader) (*http.Response, []byte, error) {
	// This is a mock function for the purpose of testing
	// In real scenario, this function will send a HTTP request and return the response
	return nil, nil, nil
}