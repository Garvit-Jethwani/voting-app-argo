...
var (
	port = "8080" // TODO: Change this to your actual port
)

// Mock httpClientRequest function
func httpClientRequest(method, url string, body io.Reader) (int, []byte, error) {
	return 200, []byte(`{"total_votes": 1}`), nil
}
